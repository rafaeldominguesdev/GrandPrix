    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="h-12 px-6 font-bold uppercase tracking-widest text-xs border-slate-200 bg-white">
            <Download className="w-5 h-5 mr-2" />
            Exportar Relatório
          </Button>
          <Button className="h-12 px-8 bg-[#008542] hover:bg-[#006e36] text-white font-black uppercase tracking-[0.2em] text-xs shadow-lg shadow-[#008542]/20">
            Ações em Lote
          </Button>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <Card className="border-slate-200 shadow-sm overflow-hidden">
            <CardHeader className="bg-slate-50/50 border-b border-slate-100">
              <div className="flex items-center justify-between">
                 ...
                 <span className="bg-red-100 text-red-600 text-xs font-black px-3 py-1 rounded-full">3 ALERTA(S)</span>
              </div>
            </CardHeader>
            <CardContent className="p-6 space-y-4">
              <div className="p-4 bg-red-50 border border-red-100 rounded-2xl space-y-2">
                ...
                <p className="text-xs text-red-700/70 font-semibold">3 relatos técnicos sem interação há mais de 48h úteis.</p>
              </div>
              <div className="p-4 bg-amber-50 border border-amber-100 rounded-2xl space-y-2">
                ...
                <p className="text-xs text-amber-700/70 font-semibold">Unidade EDISE com pico de relatos de acessibilidade digital.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-900 text-white border-none shadow-xl overflow-hidden relative group">
            <CardContent className="p-8 relative z-10 space-y-4">
              ...
              <Button className="w-full bg-[#008542] hover:bg-[#006e36] text-white font-black uppercase tracking-[0.2em] text-xs h-12 shadow-lg shadow-[#008542]/20">
                Gerenciar Time
              </Button>
            </CardContent>
            {/* BG Patterns */}
